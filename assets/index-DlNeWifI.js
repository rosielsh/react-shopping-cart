...
const CartContentWrapper = newStyled.div`
  ...
  overflow-y: scroll;
`;
const CartItemList = newStyled.ul`
  list-style: none;
  overflow-y: auto;
...
function useCartManager() {
  ...
  const selectedCartItem = reactExports.useMemo(() => {
    return (cartData == null ? void 0 : cartData.filter((_, idx) => {
      var _a;
...
function Header({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderTitle, { children: isOrderComplete ? /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderIcon, { onClick: () => setIsOrderComplete(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackArrow, {}) }) : "SHOP" }) });
}
...
function TitleSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { children: "현재 2종류의 상품이 담겨있습니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CheckBox,
      {
        text: "전체선택",
...
const CartPage = () => {
  ...
  const [isOrderComplete, setIsOrderComplete] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CartPageWrapper, { children: [
    ...
    isOrderComplete ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      OrderResult,
      {
        selectedCartItem,
      ...
      isCartEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyCart, { children: "장바구니에 담은 상품이 없습니다." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TitleSection, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      OrderButton,
      {
        ...
        children: isOrderComplete ? "결제하기" : "주문 확인"
      }
    )
  ] }) });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartPage, {}) }) });
}
